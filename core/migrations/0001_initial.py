    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Business', 'Business'), ('Personal', 'Personal'), ('Other', 'Other'), ('Home', 'Home'), ('Work', 'Work')], max_length=20)),
                ...
                ('notify', models.DateTimeField(default=datetime.datetime.now)),
